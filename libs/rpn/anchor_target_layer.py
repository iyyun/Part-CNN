...
from detection.bbox_transform import bbox_transform
import pdb

DEBUG = False

def anchor_target_layer(rpn_cls_score, gt_boxes, img_info, data, _feat_stride = [16,], anchor_scales = [4 ,8, 16, 32]):
    """
